          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-orange-400">class</span>
                <span className="mr-2 text-white">Janmejay</span>
                <span className="text-gray-400">{'{'}</span>
              </div>

              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-pink-500">private</span>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-pink-500">private</span>
                <span className="mr-2 text-orange-400">boolean</span>
                <span className="mr-2 text-white">hardWorker</span>
                <span className="text-pink-500">=</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">;</span>
              ...
              {/* <div className="ml-4 lg:ml-8 mr-2 text-green-400">public</div> */}
              <div className="ml-8 lg:ml-16">
                <span className="ml-2 mr-2 text-green-400">public</span>
                <span className="text-orange-400">boolean</span>
                <span className="ml-2 mr-2 text-white">isHireable()</span>
                <span className="text-gray-400">{'{'}</span>
              </div>

              <div className="ml-12 lg:ml-24 mr-2 text-orange-400">return</div>
              <div className="ml-16 lg:ml-32">
                <span className="text-cyan-400">hardWorker</span>
                <span className="text-amber-300"> && </span>
                <span className="text-cyan-400">problemSolver</span>
                <span className="text-amber-300"> && </span>
                <span className="text-cyan-400">skills.length</span>
                <span className="text-amber-300">&gt;=</span>
                <span className="text-orange-400">5</span>
                <span className="text-gray-400">;</span>
              </div>
